...
export default function GiftPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      >
        aapke liye kuch pyara sa , please maaf kr do na bachha ... 💝
      </motion.h2>
              ...
              <AnimatePresence>
                {showSurprise && (
                  ...
                  >
                    ...
                    >
                      aapke liye aapka jaisa pyara sa rose...🌹
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                       kasam se pakka ab koi glti nhi karenge, or abh kabhi tumko hurt 
                         nhi karenge .💖
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
