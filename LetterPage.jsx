  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          kab se wait kar rhi hu aa jao naaa…🌙
        </motion.h2>
        ...
        >
          ...
          >
            aap hamse itna pyar karte ho, but phir bhi ham hurt kiye… I'm so sorry.💔
          </motion.p>
          ...
          >
            ham jante hai sorry bolne se jo ham hurt kiye hai vo thik nhi hoga, but ek last chance de do pleaseee. please bas ek chance na babuuuu, jaise shorts wale baat pe ek chance diye to sudhar gye naa , plese ek last chance de do. pakka promise , kasam se ab koi galti nhi karenge.✨
          </motion.p>
          <motion.p
